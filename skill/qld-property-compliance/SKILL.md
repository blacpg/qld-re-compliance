...
2. **Select the module:** `form-6-appointment`, `commission`, `marketing-and-price`, `offers-and-negotiation`, `seller-disclosure`, `cooling-off`, `auction-conduct`, or `interest-disclosure`. If none fits, go to the Refusal Protocol.
